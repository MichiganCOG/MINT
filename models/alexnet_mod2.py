...
class Alexnet_mod2(nn.Module):
    ...
    def __init__(self, num_classes=1000):
        super(Alexnet_mod2, self).__init__()
        ...
        self.linear1 = MaskedLinear(256 * 6 * 6, 128)
        self.relu6   = nn.ReLU(inplace=True)
        self.drop2   = nn.Dropout()
        self.linear2 = MaskedLinear(128, 128)
        self.relu7   = nn.ReLU(inplace=True)
        self.linear3 = MaskedLinear(128, 10)
