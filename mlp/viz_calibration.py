...
plt.title('MINT MLP', fontsize=38)
#plt.title('Orig. MLP', fontsize=38)
plt.tick_params(labelsize=30)
plt.setp(ax.spines.values(), linewidth=1, color ='k')
plt.xlim((0,1))
plt.ylim((0,1))
#fig.savefig('./calibration_orig_mlp.pdf', format='pdf', dpi=1200)
fig.savefig('./calibration_mint_mlp.pdf', format='pdf', dpi=1200)
#plt.show()
