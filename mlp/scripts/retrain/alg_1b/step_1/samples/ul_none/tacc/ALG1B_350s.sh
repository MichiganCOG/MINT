#!/bin/bash
#SBATCH --job-name="ALG1B_MNIST_MLP_350s_RETRAIN"
#SBATCH --output="ALG1B_MNIST_MLP_350s_%j_RETRAIN.out"
...
export LAUNCHER_JOB_FILE="/work/07080/salimeh/maverick2/MINT/MINT/mlp/scripts/retrain/alg_1b/step_1/samples/ul_none/tacc/ALG1B_350s.slurm"
