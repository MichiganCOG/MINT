#!/bin/bash
#SBATCH --job-name="ALG1B_MNIST_MLP_50g_RETRAIN"
#SBATCH --output="ALG1B_MNIST_MLP_50g_%j_RETRAIN.out"
...
export LAUNCHER_JOB_FILE="/work/07080/salimeh/maverick2/MINT/MINT/mlp/slurm/retrain/alg_1b/step_1/ul_none/tacc/ALG1B_50g.slurm"
