#!/bin/bash
#SBATCH --job-name="ALG1B_MNIST_MLP_30g_PRUNE"
#SBATCH --output="ALG1B_MNIST_MLP_30g_%j_PRUNE.out"
...
export LAUNCHER_JOB_FILE="/work/07080/salimeh/maverick2/MINT/MINT/mlp/slurm/prune/alg_1b/tacc/ALG1B_30g.slurm"
