#!/bin/bash
#SBATCH --job-name="ALG1B_MNIST_MLP_300s_PRUNE"
#SBATCH --output="ALG1B_MNIST_MLP_300s_%j_PRUNE.out"
...
export LAUNCHER_JOB_FILE="/work/07080/salimeh/maverick2/MINT/MINT/mlp/slurm/prune/alg_1b/samples/tacc/ALG1B_300s.slurm"
